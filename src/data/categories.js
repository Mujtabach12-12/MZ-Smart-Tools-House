...
export const categories = [
  ...
  { slug: "ai-tools", name: "AI", route: "/ai-tools", accent: "violet", description: "Server-backed AI utilities that never expose provider keys in the browser.", icon: "sparkles" },
