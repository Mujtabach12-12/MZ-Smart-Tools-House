 ...
 */
const tools = [
    { id: "ai-writing-assistant", name: "AI Writing Assistant", category: "ai-tools", description: "A polished AI writing workspace for rewriting, summaries, outlines and explanations — coming soon.", icon: "sparkles", keywords: ["ai", "rewrite", "summarize", "assignment", "email"], aliases: ["AI writer", "AI assistant"], status: "active", isNew: true, requiresBackend: true, requiresApi: true, requiresInternet: true, processingType: "api" },
