 ...
 */
const tools = [
    { id: "ai-writing-assistant", name: "AI Writing Assistant", category: "ai-tools", description: "Use a configured server-side AI provider for rewriting, summaries, outlines and explanations without exposing API keys.", icon: "sparkles", keywords: ["ai", "rewrite", "summarize", "assignment", "email"], aliases: ["AI writer", "AI assistant"], status: "active", isNew: true, requiresBackend: true, requiresApi: true, requiresInternet: true, processingType: "api" },
  ...
  { id: "programming-lab", name: "MZ Programming Lab", category: "programming-tools", description: "Run JavaScript and web playgrounds in browser sandboxes, with a secure backend contract for compiled/runtime languages.", icon: "code", keywords: ["cpp", "c++", "python", "java", "compiler", "coding lab", "run code", "html css js"], aliases: ["C++ Compiler", "Python Compiler", "Code Runner"], status: "active", popular: true, isNew: true, requiresBackend: false, processingType: "hybrid" },
  ...
  // ---------------------------------------------------------------- Calculators
  { id: "gpa-calculator", name: "GPA & CGPA Calculator for Pakistani Universities", category: "calculators", description: "Calculate GPA and CGPA using university-specific grading policies for Pakistani universities.", icon: "calculator", keywords: ["gpa", "cgpa", "pakistan university", "grade point average", "semester"], status: "active", popular: true },
  { id: "cgpa-calculator", name: "CGPA Calculator for Pakistani Universities", category: "calculators", description: "Calculate cumulative CGPA using the selected university grading policy and semester credit hours.", icon: "calculator", keywords: ["cgpa", "cumulative gpa", "pakistan university", "university"], status: "active", popular: true },
  ...
  { id: "grade-calculator", name: "Grade Calculator", category: "calculators", description: "Convert marks or percentage into a letter grade.", icon: "calculator", keywords: ["grade", "letter grade"], status: "active" },
  ...
  { id: "unix-timestamp-converter", name: "Unix Timestamp Converter", category: "developer-tools", description: "Convert between Unix timestamps and human-readable dates.", icon: "clock", keywords: ["unix timestamp", "epoch"], status: "active" },
...
// ---------------------------------------------------------------- Phase 14-style expansion: browser-first utility suite
  ...
  { id: "investment-growth-calculator", name: "Investment Growth Calculator", category: "finance-tools", description: "Estimate compound growth over time.", icon: "calculator", keywords: ["investment growth"], status: "active" },
  ...
  { id: "budget-planner", name: "Budget Planner", category: "finance-tools", description: "Estimate a simple monthly budget allocation.", icon: "calendar", keywords: ["budget"], status: "active" },
  { id: "salary-breakdown-calculator", name: "Salary Breakdown Calculator", category: "finance-tools", description: "Break an annual amount into monthly and weekly equivalents.", icon: "calculator", keywords: ["salary"], status: "active" },
  { id: "loan-affordability-calculator", name: "Loan Affordability Calculator", category: "finance-tools", description: "Estimate a simple annual-income-based borrowing ceiling.", icon: "calculator", keywords: ["loan affordability"], status: "active" },
  ...
  { id: "uol-gpa-calculator", name: "UOL GPA Calculator", category: "university-tools", description: "Calculate GPA using the University of Lahore 2024 handbook grading scale.", icon: "graduation-cap", keywords: ["uol gpa", "university of lahore"], status: "active", popular: true },
  { id: "ucp-gpa-calculator", name: "UCP GPA Calculator", category: "university-tools", description: "Calculate GPA using UCP's published 4-point grading scale.", icon: "graduation-cap", keywords: ["ucp gpa", "university of central punjab"], status: "active", popular: true },
  ...
  { id: "color-converter", name: "HEX to RGB Converter", category: "developer-tools", description: "Convert a six-digit HEX color to RGB.", icon: "calculator", keywords: ["hex rgb", "color"], status: "active" },
  ...
  { id: "html-unescape", name: "HTML Unescape", category: "developer-tools", description: "Decode common HTML entities using the browser DOM.", icon: "code", keywords: ["html unescape"], status: "active" },
  ...
  { id: "unix-timestamp-converter-plus", name: "Unix Timestamp Converter Pro", category: "developer-tools", description: "Convert Unix timestamps into ISO dates.", icon: "clock", keywords: ["unix timestamp"], status: "active" },
