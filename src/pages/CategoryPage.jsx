...
export default function CategoryPage({slugOverride}){
 ...
 return <div className="mz-section py-8 sm:py-12"><Seo path={route} title={`${category.name} – Online Tools`} description={`${category.description} Explore ${list.length} focused tools at MZ Smart Tool House.`} schema={schema}/><Breadcrumbs items={[{label:category.name}]}/>
