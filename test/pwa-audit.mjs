...
if (!header.includes('mz-pwa-install-request')) throw new Error('Mobile header is missing the Install App action');
if (!mobileNav.includes('smart-document-scanner')) throw new Error('Mobile app navigation is missing the scanner primary action');
